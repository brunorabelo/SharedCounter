...
echo DJANGO_ALLOWED_HOSTS=$SECRET_KEY >> .env
...
echo IMAGE=$CI_REGISTRY/$CI_PROJECT_NAMESPACE/$CI_PROJECT_NAME >> .env.db
echo SERVER_IP=$SERVER_IP >> .env.db
echo SERVER_USER=$SERVER_USER >> .env.db
